# Download IMDB dataset and glove embeddings
import numpy as np
...
dataset_dir = '/drive/My Drive/Colab Notebooks/MachineLearning2/Final Report/Imdb/'
glove_dir = '/drive/My Drive/Colab Notebooks/MachineLearning2/Final Report/glove.6B/'
...
np.save(dataset_dir + 'Res/test_text.npy', test_texts)
np.save(dataset_dir + 'Res/test_label.npy', test_labels)
...
# save
with open(dataset_dir + 'Res/tokenizer.pickle', 'wb') as handle:
...
np.save(dataset_dir + 'Res/embedding_matrix.npy', embedding_matrix)
